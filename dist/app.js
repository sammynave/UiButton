...
var $i={"component:/ui-button/components/App":class extends q{},"template:/ui-button/components/App":{id:"2ZvOQl6p",block:'{"symbols":[],"statements":[[5,"UiButton",[],[[],[]],{"statements":[],"parameters":[]}],[0,"\\n"],[5,"UiHeader",[],[[],[]],{"statements":[[0,"hi"]],"parameters":[]}],[0,"\\n"]],"hasEval":false}',meta:{specifier:"template:/ui-button/components/App"}},"component:/ui-button/components/UiButton":Ui,"template:/ui-button/components/UiButton":{id:"vftMrVFC",block:'{"symbols":[],"statements":[[6,"button"],[11,"class",[27,["ui-button ",[26,"if",[[22,["hasClicks"]],"ui-button--red"],null]]]],[11,"onclick",[26,"action",[[22,["click"]]],null],null],[8],[0,"\\n"],[4,"if",[[22,["hasClicks"]]],null,{"statements":[[0,"    click count: "],[1,[20,"clickCount"],false],[0,"\\n"]],"parameters":[]},{"statements":[[0,"    click me\\n"]],"parameters":[]}],[9],[0,"\\n"]],"hasEval":false}',meta:{specifier:"template:/ui-button/components/UiButton"}},"component:/ui-button/components/UiHeader":class extends q{},"template:/ui-button/components/UiHeader":{id:"hzrpVlcF",block:'{"symbols":["&default"],"statements":[[6,"div"],[10,"class","ui-header"],[8],[0,"\\n  "],[13,1],[0,"\\n"],[9],[0,"\\n"]],"hasEval":false}',meta:{specifier:"template:/ui-button/components/UiHeader"}}},Gi={app:{name:"ui-button",rootName:"ui-button"},types:{application:{definitiveCollection:"main"},component:{definitiveCollection:"components"},"component-test":{unresolvable:!0},helper:{definitiveCollection:"components"},"helper-test":{unresolvable:!0},renderer:{definitiveCollection:"main"},template:{definitiveCollection:"components"}},collections:{main:{types:["application","renderer"]},components:{group:"ui",types:["component","component-test","template","helper","helper-test"],defaultType:"component",privateCollections:["utils"]},styles:{group:"ui",unresolvable:!0},utils:{unresolvable:!0}}}
const Yi=new class extends di{constructor(){let t=new Hi($i),e=new Vi(Gi,t)
const s=document.body
super({builder:new Ri({element:s,nextSibling:null}),loader:new Di(e),renderer:new Mi,resolver:e,rootName:Gi.app.rootName})}}
X=(()=>{Yi.scheduleRerender()}),Yi.registerInitializer({initialize(t){t.register(`component-manager:/${Yi.rootName}/component-managers/main`,si)}}),Yi.renderComponent("App",document.getElementById("app"),null),Yi.boot(),function(t,e){for(let s in e)ni(t,s,e[s])}(Yi,{"ui-button":"UiButton","ui-header":"UiHeader"})})
